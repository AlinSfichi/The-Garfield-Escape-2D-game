...
public class GameWinState extends State
{
    ...
    /*! \fn public GameWinState(RefLinks refLink)
        \brief Constructorul de initializare al clasei.

        \param refLink O referinta catre un obiect "shortcut", obiect ce contine o serie de referinte utile in program.
     */
    public GameWinState(RefLinks refLink)
    {
        super(refLink);
        uiManager=new UIManager(refLink);
        refLink.GetMouseManager().setUIManager(uiManager);

        uiManager.addObject(new UIImageButton(400, 300, 192, 64, Assets.exit_btn, new ClickListener() {
            @Override
            public void onClick() {
    ...
    public void Render(Graphics g) {
        ...
        try {
            ...
            Text.drawString(g,"YOU  WIN",230,100,Color.WHITE);

            g.setFont(new Font("Arial", Font.BOLD, 60));
            Text.drawString(g,"Congratulations!",230,200,Color.WHITE);
            uiManager.Render(g);
        }
